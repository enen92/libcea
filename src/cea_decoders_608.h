...
#ifndef CEA_DECODER_608_H
#define CEA_DECODER_608_H
...
/*
   This variable (cea_decoder_608_report) holds data on the cc channels that are encountered during file parse.
...
} cea_decoder_608_settings;

typedef struct cea_decoder_608_context
{
	cea_decoder_608_settings *settings;
	...
	enum cea_decoder_608_color_code current_color; // Color we are currently using to write
